...
from finetune_shakespeare.shakespeare_chunker import chunk_shakespeare_text, save_chunks_jsonl
from finetune_shakespeare.train_lora import load_config, train_lora
...
def run(
    ...
    if resolved_chunks_path.exists() and not rebuild_chunks:
        ...
        from finetune_shakespeare.train_lora import read_chunks_jsonl
